...
class Inference:
    ...
    def analysis_seaborn(self):
        ...
        plt.title("Total HIV Diagnoses by Ethnicity and Sex (Seaborn)")
        plt.xlabel("Ethnicity")
        plt.ylabel("Sum of Total HIV Diagnoses")
    ...
    def analysis_matplotlib(self):
        ...
        axes[0].set_title("Matplotlib Plot with Filtering")
        axes[0].set_ylabel("Sum of TOTAL NUMBER OF CONCURRENT HIV/AIDS DIAGNOSES")
        axes[0].set_xlabel("Combined Age")
        axes[0].set_xticks(
        ...
        axes[1].set_ylabel("Sum of Total HIV Diagnoses")
        axes[1].set_title("Total HIV Diagnoses by Ethnicity and Sex (Matplotlib)")
